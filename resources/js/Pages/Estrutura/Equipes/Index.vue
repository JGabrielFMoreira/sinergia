    ...
    <app-layout title="Dashboard">
            ...
            <DialogModal :show="showModal">
              ...
              ">
                    ...
                    <form id="form" @submit.prevent="submit">
                      ...
                      tracking-widest
                    ">EQUIPE</label>
                                <input required v-model="form.name" style="width: 100%" type="text" name="name"
                                    id="name" class="
                      mt-1
                    ...
                    " />
                      ...
                      tracking-widest
                    ">FISCAL</label>
                                <select required v-model="form.fiscal" style="width: 100%" name="fiscal" id="fiscal"
                                    class="
                      mt-1
                      focus:bg-white focus:border-blue-400
                      shadow-sm
                      ...
                      rounded-md
                    ">
                                    <option v-for="fiscal in fiscais" :key="fiscal.id" :value="fiscal.id">
                                        {{ fiscal.name }}
                                    </option>
                                </select>
                            </div>
                            <div class="col-span-4">
                                <label for="supervisor" class="
                      block
                      text-xs text-black
                      uppercase
                      font-bold
                      tracking-widest
                    ">SUPERVISOR</label>
                                <select required v-model="form.supervisor" style="width: 100%" name="supervisor"
                                    id="supervisor" class="
                      mt-1
                      focus:bg-white focus:border-blue-400
                      shadow-sm
                    ...
                    ">
                      ...
                      tracking-widest
                    ">STATUS</label>
                                <select required v-model="form.status" style="width: 100%" name="status" id="status"
                                    class="
                      mt-1
                      focus:bg-white focus:border-blue-400
                      shadow-sm
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            ">
                    ...
                    <tbody v-for="equipe in equipes.data" :key="equipe.id" class="divide-y divide-gray-200">
                        <tr class="text-center">
                            ...
                            <td class="text-xs px-2 py-2">
                                <Link :href="route('equipes.show', equipe.id)" class="
                      ml-3
                      hover:underline
                      bg-blue-100
            ...
            <div class="mt-2 flex flex-col items-center">
                ...
                <div class="inline-flex xs:mt-0">
                    <Link :href="equipes.prev_page_url" class="
                py-2
                px-4
                text-sm
                font-medium
              ...
              ">
                    ...
                    <Link :href="equipes.next_page_url" class="
                py-2
                px-4
                text-sm
                font-medium
...
export default defineComponent({
    ...
    methods: {
        submit() {
            this.form.post(this.route("equipes.store"));
            this.showModal = false;
        },
        submitPesquisa() {
            this.formPesquisa.get(this.route("equipes.index"));
        },
    },
});
</script>