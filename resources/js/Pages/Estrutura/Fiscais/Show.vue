    ...
    <app-layout title="Dashboard">
        <template #header>
            <div class="flex justify-end">
                <Link :href="route('fiscais.index')" class="
              inline-flex
              items-center
              px-4
              py-1
            ...
            <DialogModal :show="showModal">
              ...
              ">
                    ...
                    " />
                      ...
                      tracking-widest
                    ">SUPERVISOR</label>
                                <select required v-model="form.supervisor_id" style="width: 100%" name="area" id="area"
                                    class="
                      mt-1
                      focus:bg-white focus:border-blue-400
                      shadow-sm
                    ...
                    ">
                      ...
                      tracking-widest
                    ">EMPRESA</label>
                                <select required v-model="form.empresa_id" style="width: 100%" name="empresa" id="empresa"
                                    class="
                      mt-1
                      focus:bg-white focus:border-blue-400
                      shadow-sm
...
export default defineComponent({
    ...
    methods: {
        submit() {
            this.form.put(this.route("fiscais.update", this.fiscal.id));
            this.showModal = false;
        },
        submitDelete() {
            this.formDelete.delete(
                this.route("fiscais.destroy", this.fiscal.id)
            );
